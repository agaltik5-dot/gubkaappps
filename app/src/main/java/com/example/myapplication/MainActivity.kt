...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupScheduleList() {
        ...
        val sampleLessons = listOf(
            Lesson("Высшая математика", "08:00", "09:30", "Лекция", "А-201 · Соколов А.В.", "2ч"),
            Lesson("Программирование", "10:00", "11:30", "Лабораторная", "В-305 · Иванов К.Е.", "2ч"),
            Lesson("Иностранный язык", "12:00", "13:30", "Семинар", "Б-221 · Смирнова О.А.", "2ч"),
            Lesson("Физика", "14:00", "15:30", "Лекция", "А-101 · Громов П.И.", "2ч")
        )
